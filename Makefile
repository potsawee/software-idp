...
testroute2 :  testroute2.o routes.o movements.o mechanisms.o line_following.o
	 g++ -L/export/teach/1BRobot -o testroute2  testroute2.o  routes.o  movements.o  mechanisms.o  line_following.o  -lrobot

testroute2.o: testroute2.cc header.h
	 g++ -ansi -Wall -g -I/export/teach/1BRobot -c testroute2.cc
