...
testroute1 :  testroute1.o routes.o movements.o line_following.o
	 g++ -L/export/teach/1BRobot -o testroute1  testroute1.o  routes.o  movements.o  line_following.o  -lrobot
